...
import (
	...
	"kubestash.dev/installer/hack/fmt/templates"
...
func main() {
	...
	tplDir := "charts/kubestash-catalog/templates"
	...
	for _, ri := range resources {
		...
		appDir := filepath.Join(dir, "charts", "kubestash-catalog", "templates", app)
...

	{
		...
		out, err := sh.Command("helm", "template", "charts/kubestash-catalog").Output()
		if err != nil {
			panic(err)
		}
