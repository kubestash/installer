...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubestash/volume-snapshotter:v0.28.0-rc.0 images/kubestash-volume-snapshotter-v0.28.0-rc.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubestash/workload:v0.28.0-rc.0 images/kubestash-workload-v0.28.0-rc.0.tar
