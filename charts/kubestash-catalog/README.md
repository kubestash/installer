...
$ helm repo update
$ helm search repo appscode/kubestash-catalog --version=v2026.8.12-rc.0
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.8.12-rc.0
```
...
```bash
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.8.12-rc.0 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.8.12-rc.0 --values values.yaml
```
