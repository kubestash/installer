...
$ helm repo update
$ helm search repo appscode/kubestash-catalog --version=v2026.2.27
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.2.27
```
...
```bash
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.2.27 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.2.27 --values values.yaml
```
