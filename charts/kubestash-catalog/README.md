...
$ helm repo update
$ helm search repo appscode/kubestash-catalog --version=v2026.6.18-rc.2
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.6.18-rc.2
```
...
```bash
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.6.18-rc.2 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.6.18-rc.2 --values values.yaml
```
