...
$ helm repo update
$ helm search repo appscode/kubestash-catalog --version=v2026.2.26
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.2.26
```
...
```bash
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.2.26 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2026.2.26 --values values.yaml
```
