...
$ helm repo update
$ helm search repo appscode/kubestash-catalog --version=v2025.3.24
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2025.3.24
```
...
```bash
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2025.3.24 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubestash-catalog appscode/kubestash-catalog -n kubestash --create-namespace --version=v2025.3.24 --values values.yaml
```
