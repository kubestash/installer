...
$ helm repo update
$ helm search repo appscode/kubestash-metrics --version=v2026.5.18-rc.0
$ helm upgrade -i kubestash-metrics appscode/kubestash-metrics -n kubestash --create-namespace --version=v2026.5.18-rc.0
```
