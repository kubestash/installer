...
$ helm repo update
$ helm search repo appscode/kubestash-metrics --version=v2026.7.10
$ helm upgrade -i kubestash-metrics appscode/kubestash-metrics -n kubestash --create-namespace --version=v2026.7.10
```
