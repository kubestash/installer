...
$ helm repo update
$ helm search repo appscode/kubestash-metrics --version=v2024.12.9
$ helm upgrade -i kubestash-metrics appscode/kubestash-metrics -n kubestash --create-namespace --version=v2024.12.9
```
