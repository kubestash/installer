...
$ helm repo update
$ helm search repo appscode/kubestash-metrics --version=v2025.12.15
$ helm upgrade -i kubestash-metrics appscode/kubestash-metrics -n kubestash --create-namespace --version=v2025.12.15
```
