...
$ helm repo update
$ helm search repo appscode/kubestash --version=v2024.6.4
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2024.6.4
```
...
```bash
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2024.6.4 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2024.6.4 --values values.yaml
```
