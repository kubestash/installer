...
$ helm repo update
$ helm search repo appscode/kubestash --version=v2024.12.9
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2024.12.9
```
...
```bash
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2024.12.9 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2024.12.9 --values values.yaml
```
