...
$ helm repo update
$ helm search repo appscode/kubestash --version=v2025.2.6-rc.0
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2025.2.6-rc.0
```
...
```bash
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2025.2.6-rc.0 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2025.2.6-rc.0 --values values.yaml
```
