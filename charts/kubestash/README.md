...
$ helm repo update
$ helm search repo appscode/kubestash --version=v2025.12.15
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2025.12.15
```
...
```bash
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2025.12.15 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i kubestash appscode/kubestash -n kubestash --create-namespace --version=v2025.12.15 --values values.yaml
```
