# kubestash-certified-crds

[kubestash-certified-crds](https://github.com/kubestash) - Backup your Kubernetes native applications
...
$ helm repo update
$ helm search repo appscode/kubestash-certified-crds --version=v2025.12.15
$ helm upgrade -i kubestash-certified-crds appscode/kubestash-certified-crds -n kubestash --create-namespace --version=v2025.12.15
```
...
To install/upgrade the chart with the release name `kubestash-certified-crds`:
...
To uninstall the `kubestash-certified-crds`:

```bash
$ helm uninstall kubestash-certified-crds -n kubestash
```
...
The following table lists the configurable parameters of the `kubestash-certified-crds` chart and their default values.
...
```bash
$ helm upgrade -i kubestash-certified-crds appscode/kubestash-certified-crds -n kubestash --create-namespace --version=v2025.12.15 --set global.registry=stashed
```
...
```bash
$ helm upgrade -i kubestash-certified-crds appscode/kubestash-certified-crds -n kubestash --create-namespace --version=v2025.12.15 --values values.yaml
```
